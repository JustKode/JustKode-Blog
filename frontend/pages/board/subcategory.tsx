...
class SubCategoryAll extends Component<any, any> {
  ...
  render() {
    ...
    return (
      <Layout>
        <Head>
          <title>{this.props.category.full_name} : Page {this.props.page}</title>
          <meta name="description" content={`${this.props.category.full_name} ${this.props.page} 페이지`}></meta>
          <meta property="og:image" content="/static/banner-image.jpg"></meta>
          <meta property="og:description" content={`${this.props.category.full_name} ${this.props.page} 페이지`}></meta>
          <meta property="og:title" content={`${this.props.category.full_name} : Page ${this.props.page}`}></meta>
        </Head>
        <MainContainer>
          <SubContainer>
